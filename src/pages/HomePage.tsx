  ...
  return (
    <div className="flex flex-col page-transition overflow-x-hidden">
      ...
      <section className="relative pt-8 pb-24 md:pt-16 md:pb-48 hero-glow overflow-hidden">
        {/* Radial glow orbs */}
        <div aria-hidden="true" className="pointer-events-none absolute left-0 top-1/3 -translate-x-1/2 w-[480px] h-[480px] rounded-full z-0" style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.15) 0%, transparent 70%)', filter: 'blur(90px)' }} />
        <div aria-hidden="true" className="pointer-events-none absolute right-0 top-1/3 translate-x-1/2 w-[480px] h-[480px] rounded-full z-0" style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.15) 0%, transparent 70%)', filter: 'blur(90px)' }} />
