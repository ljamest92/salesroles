...
const Avatar = UIAvatar as any
const AvatarFallback = UIAvatarFallback as any
const TooltipContent = UITooltipContent as any
    ...
    <TooltipProvider delayDuration={0}>
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-2 py-2 space-y-0.5">
          {!collapsed && (
            <p className="px-3 pt-1 pb-1 text-[10px] font-medium text-muted-foreground">
              Main
            </p>
          )}
          {NAV_ITEMS.map(item => (
